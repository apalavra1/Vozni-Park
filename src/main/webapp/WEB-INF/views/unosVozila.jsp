...
<body>
  <div id="wrap">
    <div id="regbar">
      <div id="navthing">
        <h2><a href="unosVozila" id="unosvozilaform" style="color: red">Unos vozila</a> | <a href="mojaVozila" id="mojavozilaform">Moja vozila</a> | <a href="mapa" id="mapaform">Mapa</a> | <a href="odjava" id="odjavaform">Odjava</a></h2>
